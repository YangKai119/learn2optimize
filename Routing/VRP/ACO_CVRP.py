...
def plotRoutes(model):
    ...
    obj = best_sol.obj
    name = 'ACO'
    DrawPointMap(node_list,depot,routes,name,obj)
...
if __name__=='__main__':
    file='../data/cvrp.xlsx'
    run(filepath=file,Q=10,alpha=1,beta=5,rho=0.1,epochs=100,v_cap=250,opt_type=1,popsize=60)
